/* global QUnit */
import MobiledocParser from 'content-kit-compiler/parsers/mobiledoc';
import { generateBuilder } from 'content-kit-compiler/post-builder';

const {test} = QUnit;

let parser, builder, post;

QUnit.module('Unit: Parsers: Mobiledoc', {
  beforeEach() {
